...
<body>
    ...
    <script src="../../fatecsrdsii202502/assets/js/jquery-3.6.0.min.js" type="text/javascript"></script>
    <script src="../../fatecsrdsii202502/assets/js/bootstrap.min.js" type="text/javascript"></script>
    <script src="../../fatecsrdsii202502/assets/js/sweetalert2.all.min.js" type="text/javascript"></script>
    ...
    <script>
        ...
        function filtrarTabela() {
            ...
            for (let i = 0; i < linhas.length; i++) {
                ...
                const colDataIni = linhas[i].getElementsByTagName("td")[3]; // Coluna da Data de Início
