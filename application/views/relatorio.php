...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mt-4">
                        ...
                        <button class="btn btn-outline-primary btnAcao"
                            onclick="imprimirRelatorio('tabelaRelatorio')">Imprimir Relatório de Chaves</button>
                        <button class="btn btn-outline-primary btnAcao"
                            onclick="imprimirRelatorioVisualizacao()">Imprimir Relatório de Visualização</button>
                        <button class="btn btn-outline-primary btnAcao"
    ...
    <script>
        ...
        function imprimirRelatorioTV() {
            ...
            let containerPrincipal = document.getElementById('conteudoPrincipal'); // Adicione um ID no conteúdo orig
            ...
            let estilos = `
                <style>
                    * { margin: 0; padding: 0; box-sizing: border-box; }
                    ...
                    #relatorioTV { position: fixed; top: 0; left: 0; width: 100%; height: 100%; background-color: #1C1C1C; color: white; display: flex; flex-direction: column; align-items: center; justify-content: flex-start; padding: 20px; }
                    .card-container { display: flex; flex-wrap: wrap; gap: 10px; justify-content: center; max-width: 90vw; overflow-y: auto; margin-top: 100px; }
                    .card { width: 200px; height: 200px; padding: 10px; display: flex; flex-direction: column; justify-content: center; align-items: center; border-radius: 10px; color: white; font-size: 14px; font-weight: bold; text-align: center; }
                    ...
                    .btn-voltar, .btn-periodo { font-size: 16px; padding: 10px 20px; cursor: pointer; border-radius: 5px; color: white; }
